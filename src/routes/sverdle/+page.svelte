...
<svelte:head>
	<title>Слова</title>
	<meta name="description" content="Клон Wordle, написанный на SvelteKit." />
</svelte:head>

<h1 class="visually-hidden">Слова</h1>
...
>
	<a class="how-to-play" href="/sverdle/how-to-play">Как играть</a>
